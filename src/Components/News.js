        ...
        return (
            <div className="container my-3">
                ...
                <div className='container- d-flex justify-content-between'>
                    ...
                    <button disabled={this.state.page <= 1} type="button" class="btn btn-dark" onClick={this.handelPrevClick}>Previous &larr;</button>
                    <button type="button" class="btn btn-dark" onClick={this.handelNextClick}>&rarr; Next</button>
